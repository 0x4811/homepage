...
const translations = {
  ...
  en: {
    ...
    'about.body3': 'The most dangerous attack no longer comes from a laptop in a café. I personally built a tool that automatically calls people — using a cloned AI voice of their bank, their CEO, the helpdesk, or someone they know. Personalised from leaked data, like the recent Odido breach. Convincing. Instant. Almost indistinguishable from the real thing. I demonstrate it live: you see it from the attacker\'s side — and you get the call yourself.',
    ...
    'speaking.r5.title': 'AI Voice Phishing Demo',
    'speaking.r5.badge': 'New',
    'speaking.r5.desc': "A live demonstration where I automatically call people \u2014 posing as their bank, a CEO, helpdesk agent or friend \u2014 using cloned AI voices. Using realistic scenarios like the Odido data breach, I show how fraudsters operate. Attendees see the attack from the attacker\u2019s side and experience first-hand how convincing the call sounds.",
